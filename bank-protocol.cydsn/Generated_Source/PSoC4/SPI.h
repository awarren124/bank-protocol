...
#define SPI_COMP_VERSION_MAJOR    (4)
#define SPI_COMP_VERSION_MINOR    (0)
...
*/
#define SPI_SCB_SW_RESET   SPI_I2CFwBlockReset()
...
#define SPI_DISABLE_AUTO_DATA \
                do{                        \
                    SPI_I2C_CTRL_REG &= ((uint32) ~(SPI_I2C_CTRL_M_READY_DATA_ACK      |  \
                                                                 SPI_I2C_CTRL_M_NOT_READY_DATA_NACK |  \
                                                                 SPI_I2C_CTRL_S_READY_DATA_ACK      |  \
                                                                 SPI_I2C_CTRL_S_NOT_READY_DATA_NACK)); \
                }while(0)
...
#define SPI_GET_UART_RX_CTRL_BREAK_WIDTH(width)    (((uint32) ((uint32) (width) - 1u) << \
                                                                    SPI_UART_RX_CTRL_BREAK_WIDTH_POS) & \
                                                                    SPI_UART_RX_CTRL_BREAK_WIDTH_MASK)
