...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG32((void CYFAR *)CYREG_SAR_MUX_SWITCH0, 0x00430806u);
	CY_SET_XTND_REG32((void CYFAR *)CYREG_SAR_MUX_SWITCH_HW_CTRL, 0x0043000Eu);
...
void cyfitter_cfg(void)
{
	...
	CY_SET_REG8((void *)CYREG_UDB_UDBIF_INT_CLK_CTL, 0x01u);
	{
		...
		CY_SET_REG32((void *)(CYREG_HSIOM_PORT_SEL5), 0x0000FFFFu);

		/* UDB_PA_0 Starting address: CYDEV_UDB_PA0_BASE */
		CY_SET_REG32((void *)(CYDEV_UDB_PA0_BASE), 0x00990004u);
		CY_SET_REG32((void *)(CYREG_UDB_PA0_CFG4), 0x20000000u);
		...
		CY_SET_REG32((void *)(CYREG_TCPWM_CNT3_TR_CTRL0), 0x000FFF10u);
	...
	CY_SET_REG32((void *)(CYREG_GPIO_PRT1_PC), 0x00006C60u);
	...
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT2_BASE), 0x0000005Fu);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT2_PC), 0x00186002u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT2_INTR_CFG), 0x00000002u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT2_PC2), 0x0000000Eu);
	...
	CY_SET_REG32((void *)(CYREG_GPIO_PRT5_PC), 0x00000271u);
